...
public class QueryBpmnFile {
    public static void main(String[] args) throws IOException {
        ...
        //8.构建出OutputStream流
        OutputStream pngOut =
                new FileOutputStream("C:\\Users\\Administrator\\Desktop\\"+processDefinition.getDiagramResourceName());

        OutputStream bpmnOut =
                new FileOutputStream("C:\\Users\\Administrator\\Desktop\\"+processDefinition.getResourceName());
